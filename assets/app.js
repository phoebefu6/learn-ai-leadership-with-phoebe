...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/Manager session (\d+) of 10/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = mx
        ? ["a1-leading-ai-age.html", "a2-ai-augmented-decision.html",
           "a3-ai-ready-culture.html", "a4-ethics-responsible-ai.html",
           "a5-leading-change-adoption.html", "a6-strategy-future.html"]
        : ["b1-ai-foundations-managers.html", "b2-ai-assisted-decisions.html", "b3-communication-writing.html",
           "b4-planning-prioritization.html", "b5-feedback-performance.html",
           "b6-delegation.html", "b7-meetings-synthesis.html",
           "b8-team-enablement.html", "b9-risk-ethics-practice.html", "b10-leading-augmented-teams.html"];
